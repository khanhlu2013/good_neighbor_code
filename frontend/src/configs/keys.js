...
const API_NODE = new RouteNode('','',[
  new RouteNode('profile','/profile',[
    ...
    {name:'createInvitation',path:'/createInvitation'},
    {name:'modifyInvitation',path:'/modifyInvitation'},
    {name:'friends',path:'/friends'},
  ]),
  new RouteNode('auth','/auth',[
    {name:'google',path:'/google'},
    {name:'dummy_login_for_test_purpose',path:'/dummy_login_for_test_purpose?:email?:name'},
  ]),
]);
